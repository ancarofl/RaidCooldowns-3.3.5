...
local cooldowns = {
	["DEATHKNIGHT"] = {
		...
		[GetSpellInfo(45529)] = { id = 45529, cd = 60 },            -- Blood Tap 4p
		[GetSpellInfo(71586)] = { id = 71586, cd = 120 },            -- EOF trink
		[GetSpellInfo(49016)] = { id = 49016, cd = 180 },            -- Hyst
		[GetSpellInfo(71638)] = { id = 71638, cd = 60 },            -- Sindy HC trink
		[GetSpellInfo(71635)] = { id = 71635, cd = 60 },            -- Sindy NM trink
		[GetSpellInfo(48707)] = { id = 48707, cd = 45 },            -- AMS
		[GetSpellInfo(55233)] = { id = 55233, cd = 75 },            -- Vampiric Blood
	},
	["DRUID"] = {
		...
		[GetSpellInfo(5229)]  = { id = 5229, cd = 60 },            -- Enrage 4p
		[GetSpellInfo(71586)] = { id = 71586, cd = 120 },            -- EOF trink
		[GetSpellInfo(61336)] = { id = 61336, cd = 180 },            -- SI
		[GetSpellInfo(71638)] = { id = 71638, cd = 60 },            -- Sindy HC trink
		[GetSpellInfo(71635)] = { id = 71635, cd = 60 },            -- Sindy NM trink
	...
	["PALADIN"] = {
		...
		[GetSpellInfo(54428)] = { id = 54428, cd = 60 },            -- Divine plea 4p
		[GetSpellInfo(71586)] = { id = 71586, cd = 120 },            -- EOF trink
		[GetSpellInfo(71638)] = { id = 71638, cd = 60 },            -- Sindy HC trink
		[GetSpellInfo(71635)] = { id = 71635, cd = 60 },            -- Sindy NM trink
		[GetSpellInfo(75495)] = { id = 75495, cd = 120 },            -- GTS HC trink
		[GetSpellInfo(75490)] = { id = 75490, cd = 60 },            -- GTS NM trink
		[GetSpellInfo(10308)] = { id = 10308, cd = 50 },            -- HOJ
		[GetSpellInfo(48817)] = { id = 48817, cd = 30 },            -- Holy Wrath
		[GetSpellInfo(1044)]  = { id = 1044, cd = 25 },            -- HOF
		[GetSpellInfo(1038)]  = { id = 1038, cd = 120 },            -- Ho Salv
		[GetSpellInfo(6940)]  = { id = 6940, cd = 120 },            -- Ho Sac
	},
	["PRIEST"] = {
	...
	["ROGUE"] = {
		...
		[GetSpellInfo(51690)] = { id = 51690,  cd = 120 },            -- KS	
	},
	["SHAMAN"] = {
	...
	["WARRIOR"] = {
		...
		--[GetSpellInfo(291315)]= { id = 29131, cd = 60 },            -- Bloodrage 4p
		[GetSpellInfo(71586)] = { id = 71586, cd = 120 },            -- EOF trink
		[GetSpellInfo(71638)] = { id = 71638, cd = 60 },            -- Sindy HC trink
		[GetSpellInfo(71635)] = { id = 71635, cd = 60 },            -- Sindy NM trink
		[GetSpellInfo(12292)] = { id = 12292, cd = 130 },            -- Death Wish (with Intensify Rage talent)
	},
}
